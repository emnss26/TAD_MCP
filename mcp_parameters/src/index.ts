...
function expandElementIds(
  ...
  if (useSelection || one === 0) ids.push(0); // 0 = selección actual
  return ids;
}
...
server.registerTool(
  ...
  {
    description:
      "Lee parámetros de elementos. Ejemplo: {elementIds:[344900], paramNames:['Comments']}",
...
server.registerTool(
  ...
  {
    description:
      "Actualiza parámetros con filtros. Ej: {where:{categories:['OST_Walls']}, set:[{param:'Comments',value:'ok'}]}",
